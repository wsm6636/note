...
| --------------------------- | ----------------- | --------------------- | --------------------- | --------------------- | ----------------- | ----------------- | ----------------- |
| **plan-计划<br>（今日计划）**       | 1.  <br>2. <br>3. | 1.  改论文<br>2. <br>3.  | 1.  改论文<br>2. <br>3.  | 1.  改论文<br>2. <br>3.  | 1.  <br>2. <br>3. | 1.  <br>2. <br>3. | 1.  <br>2. <br>3. |
| **do-执行<br>（已完成）**          | 1.  <br>2. <br>3. | 1.  done<br>2. <br>3. | 1.  done<br>2. <br>3. | 1.  done<br>2. <br>3. | 1.  <br>2. <br>3. | 1.  <br>2. <br>3. | 1.  <br>2. <br>3. |
...
```
![[00-ccomponents/components-20240809094456.components]]
# 本周笔记
> 手动选择日期
