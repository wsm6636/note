...
TSN 标准是一个工具箱，可以使用取决于应用程序的各种功能来提高应用程序中的通信性能。特别是，TSN 标准允许对计划流量 (ST) 进行时间隔离，该流量根据离线创建的静态计划发送。时间隔离是通过时间感知整形器 (TAS) 机制使用 TSN 交换机端口上的门操作来实现的。这保证了 ST 的时序确定性
