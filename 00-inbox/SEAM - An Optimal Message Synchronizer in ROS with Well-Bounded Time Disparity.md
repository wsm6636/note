...
![image.png](https://gcore.jsdelivr.net/gh/wsm6636/pic/202405031229398.png)
...
正如第 2 节中提到的。 I、ExactTime 和 ApproximateTime 是两种主要的 ROS 消息同步策略。
