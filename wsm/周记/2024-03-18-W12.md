...
updated: 2024-03-20T22:04
---
# 周复盘PDCA

| **复盘项目**                    | **周一**                                 | **周二**                               | **周三**                       | **周四**            | **周五**            | **周六**            | **周日**            |
| --------------------------- | -------------------------------------- | ------------------------------------ | ---------------------------- | ----------------- | ----------------- | ----------------- | ----------------- |
| **plan-计划<br>（今日计划）**       | 1.  related work<br>2. 打印资料<br>3. 整理快递 | 1.  system model<br>2. 打印资料<br>3. 取钱 | 1. 和李老师吃麻辣烫 <br>2. 改论文<br>3. | 1.  <br>2. <br>3. | 1.  <br>2. <br>3. | 1.  <br>2. <br>3. | 1.  <br>2. <br>3. |
