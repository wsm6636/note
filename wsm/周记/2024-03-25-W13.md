...
updated: 2024-03-26T23:04
---
# 周复盘PDCA

| **复盘项目**                    | **周一**                      | **周二**                                    | **周三**               | **周四**            | **周五**            | **周六**            | **周日**            |
| --------------------------- | --------------------------- | ----------------------------------------- | -------------------- | ----------------- | ----------------- | ----------------- | ----------------- |
| **plan-计划<br>（今日计划）**       | 1.  改论文<br>2. 报销签证<br>3. 补牙 | 1.  改论文<br>2. 准备自我介绍<br>3. 选座位<br>4. 报销签证 | 1.  <br>2. <br>3. 打印 | 1.  <br>2. <br>3. | 1.  <br>2. <br>3. | 1.  <br>2. <br>3. | 1.  <br>2. <br>3. |
